...
export default function Purchases() {
  return (
    <div className="purchases_panel">
      ...
      <div className="list-panel mt-4">
        <div className="item-panel row m-0 mb-3">
          <div className="title-panel p-5 d-md-block d-sm-flex  d-block col-md-3 p-0">
          ...
          <div className="order-panel p-5 col-md-9 p-0">
            ...
            <div className="btn-panel d-flex align-items-center">
              <button className="btn  btn-order-detail blue-btn round-form text-uppercase me-2 px-4 py-2">
                order details
              </button>
              <button className="btn btn-reorder round-form text-uppercase px-4 py-2">
                reorder
              </button>
            </div>
          </div>
