...
const steps = [
  {
    step: "Step 1.",
    title: "Shop",
    description: "When paying for your purchases, you receive a Global Blue Tax Free Form from the sales staff who helped you."
  },
  {
    step: "Step 2.",
    title: "Stamp",
    description: "At the airport or port, go to the Customs desk and present your completed Tax Free Form, passport, receipts and purchases to get a stamp on your form.",
    items: [
      {
  ...
  },
  {
    step: "Step 3.",
    title: "Claim",
    description: "Go to the nearby Global Blue desk or office displaying a Global Blue logo. In some cases, this will be a currency exchange. Present your stamped, completed Tax Free Form and your travel passport to receive the refund in cash or to your credit card.",
    items: [
      {
      ...
      <div className="form-section r-container py-5">
        <div className="row m-0 py-sm-5">
          <div className="col-md-4 p-0 pe-5">
            <h3 className="title blue-text">If you still experienced difficulties, please fill in the contact form.</h3>
          </div>
          <div className="col-md-8 p-0">
            <div className="form-panel d-flex">
              <input type="text" className="form-control round-form me-4 py-3 px-4" placeholder="Your name" />
              <input type="text" className="form-control round-form  py-3 px-4" placeholder="Your email" />
            </div>
            <div className="form-panel d-flex mt-4">
              <input type="text" className="form-control round-form  py-3 px-4 me-4" placeholder="Your country" />
              <input type="text" className="form-control round-form  py-3 px-4" placeholder="Your phone number" />
            </div>
              ...
              <ul className="booking-list mb-0">
                {
                  noteData.map((note, index) =>
                    <li className="mb-4" key={index}>{note}</li>
                  )
                }
              </ul>
            </div>
